            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-2">
                {teacherInfo.currentPosition.map((position, index) => (
                  <Badge key={index} variant="secondary" className="bg-yellow-100 text-yellow-800 px-3 py-1 text-sm cursor-default">
                    {position}
                  </Badge>
                ))}
              </div>
            ...
            <Card className="bg-gradient-to-r from-yellow-50 to-yellow-100 border-yellow-200">
              <CardContent className="p-6">
                <div className="text-center space-y-4">
                  ...
                  <p className="text-gray-600 text-pretty">เรียนรู้เทคนิคการแก้โจทย์ฟิสิกส์ เพื่อให้เข้าใจและได้คะแนนสูง</p>
